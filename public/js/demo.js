...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    showSwal: function(type){
        ...
        if(type == 'basic'){
            ...
            swal({
                    title: 'Put your email address',
                    html: '<div class="form-group">' +
                              '<input id="input-field" type="email" class="form-control border-input" />' +
                          '</div>',
                    showCancelButton: true,
                    confirmButtonClass: 'btn btn-success',
                    cancelButtonClass: 'btn btn-danger',
                    ...
                    swal({
                        type: 'success',
                        html: '<strong>Your mail are being sent!</strong>',
                        confirmButtonClass: 'btn btn-success',
                        buttonsStyling: false
    ...
    initGoogleMaps: function(){
        var myLatlng = new google.maps.LatLng(26.748817, 88.985428);
        var mapOptions = {
          zoom: 16,
          center: myLatlng,
    ...
    initSmallGoogleMaps: function(){
        ...
        var myLatlng = new google.maps.LatLng(26.748817, 92.985428);
        var mapOptions = {
            zoom: 13,
            center: myLatlng,
            scrollwheel: false, //we disable de scroll over the map, it is a really annoing when you scroll through page
