  ...
  //user routes start from here
    ...
    Route::prefix('admin')->group(function()
    {
      ...
      Route::middleware('admin.auth')->group(function() 
      {
        ...
        Route::put('/change_my_password', 'Admin\AdminsController@updatePassword')
        ->name('admin.password_change.admin');
        ...
        Route::put('/password/{id}', 'Admin\AdminsController@updatePass')
        ->name('admin.change.password');
        Route::delete('/admin/{id}', 'Admin\AdminsController@destroy')
        ...
        Route::controller(UsersController::class)->group(function()
        {
          ...
          Route::get('search-user', 'index')->name('user.search');
