...
<div class="wrapper">
    <div class="sidebar" data-active-color="purple" data-background-color="black" data-image="/images/login.jpg">
        <div class="logo">
            <a href="/admin" class="simple-text"><?php echo e($info['name']); ?></a>
        </div>
        <div class="logo logo-mini">
            <a href="admin" class="simple-text"><?php echo e($info['short_name']); ?></a>
        </div>
        <div class="sidebar-wrapper">
            <div class="user">
                <div class="photo">
                    <img src="<?php echo e($admin->image? $admin->image : 'avatar.png'); ?>" />
                </div>
                <div class="info">
            ...
            <ul class="nav">
                ...
                <li>
                    ...
                    <div class="collapse" id="point">
                        <ul class="nav">
                            <li>
                              <a href="<?php echo e(route('point.create')); ?>">Add New Point</a>
                            </li>
                            <li>
                              <a href="<?php echo e(route('point.index')); ?>">View Points</a>
                            </li>
                            <li>
                              <a href="<?php echo e(route('point.view.map')); ?>">View Points On Map</a>
                            </li>
                        </ul>
                    </div>
                </li>
        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/admin"> <?php echo e($info['panel_name']); ?> Admin Panel</a>
                </div>
...
<?php echo $__env->make('partials.messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>            <?php /**PATH /srv/www/cbt/resources/views/admins/header.blade.php ENDPATH**/ ?>