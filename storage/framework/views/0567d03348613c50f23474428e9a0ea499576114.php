...
<div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <table class="package-table table table-bordered">
                            ...
                            <tr>
                                <td>Price </td>
                                <td><?php echo e($package->price); ?> taka</td>
                            </tr>
                            <tr>
                                <td>VAT </td>
                                <td>0%</td>
                            ...
                            <tr>
                                <td>Discount </td>
                                <td><span><?php echo e(number_format($package->discount,0)); ?></span>%</td>
                            </tr>
                            <tr>
                                <td>Total Price </td>
                                <td><b><span><?php echo e($package->price - ($package->price*$package->discount/100)); ?></span></b> taka</td>
                            </tr>
                        </table>
                    </div>
                </div>
    ...
    <div class="col-md-7">
        <div class="card">
            ...
            <input type="hidden" name="service_id" value="<?php echo e($package->id); ?>">
                ...
                <div class="card-content">
                    ...
                    <div class="col-md-12">
                        <div class="form-group label-floating">
                            ...
                            <input type="hidden" value="<?php echo e($package->package_id); ?>" name="package_id">
                        </div>
                        <div class="form-group label-floating">
...
<?php echo $__env->make('user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/www/cbt/resources/views/users/get_package.blade.php ENDPATH**/ ?>