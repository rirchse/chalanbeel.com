...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::model($profile, ['route' => ['admin.profile.update', $profile->id], 'method' => 'PUT', 'files' => true]); ?>
        ...
        <a href="/admin/change_my_password" class="btn btn-default pull-left">Change Password</a>
...
<?php echo $__env->make('admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/www/cbt/resources/views/admins/profile.blade.php ENDPATH**/ ?>