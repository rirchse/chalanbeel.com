...
<div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <?php echo e(Form::model($address, ['route' => ['update.address', $address->id], 'method' => 'PUT', 'id' => 'RegisterValidation'])); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/www/cbt/resources/views/users/edit_address.blade.php ENDPATH**/ ?>