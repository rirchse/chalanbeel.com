...
<div class="login-page">
    ...
    <div class="login-left">
        <div class="login-left-content">
            <div class="login-logo">
                ...
                <div class="login-logo-text">চলনবিল টেকনলজি</div>
            </div>
            <h1 class="login-welcome-title">Admin Panel</h1>
            <p class="login-welcome-subtitle">
                Welcome to the admin dashboard. Please login with your admin credentials to access the management panel.
            </p>
            <a href="/" class="sign-up-btn">Back to Home</a>
        </div>
    </div>
    ...
    <div class="login-right">
        <div class="login-form-container">
            ...
            <div class="divider">
                <span class="divider-text">Or login with your credentials</span>
            </div>
