                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="/work_order/{{$workorder->id}}/edit" class="btn btn-simple btn-warning btn-icon" title="Edit the work order"><i class="material-icons">mode_edit</i></a>
                                    ...
                                    <a href="/active_work_order/{{$workorder->id}}" class="btn btn-simple btn-success btn-icon" title="Move to active work order"><i class="material-icons">replay</i></a>
