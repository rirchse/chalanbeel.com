        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group label-floating">
                    ...
                    {{ Form::text('first_name', $profile->full_name, ['class' => 'form-control'])}}
                </div>
                <div class="form-group label-floating">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group label-floating">
                    ...
                    <input type="text" class="form-control datepicker" value="{{ $profile->date_of_birth }}" name="dob">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group label-floating">
                    <label class="control-label">Profession</label>
                    <input type="text" class="form-control" value="{{ $profile->profession }}" name="job_title">
                </div>
            </div>
        </div>
